...
* Web UI for document upload and chat
* OCR for scanned PDFs
* Hybrid keyword + vector search
* Reranking model
* Per-document deletion API
* File versioning
* User authentication
...
This project is intended as a practical local RAG infrastructure for experimentation, home lab usage, and local AI agent integration.

It is not yet designed for multi-user production deployment.
